...
public class Amz_TC_09 extends Launch_Quit_Browser
{
	...
	public void login_addProd_CC_DC_PaymentOption_logout(String un, String pwd) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Assert.assertTrue("CC option is not present", checkout.is_CC_PaymentOptionSelected());
		System.out.println("CC option is selected successsfully");

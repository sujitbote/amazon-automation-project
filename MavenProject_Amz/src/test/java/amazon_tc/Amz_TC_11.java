...
public class Amz_TC_11 extends Launch_Quit_Browser
{
	...
	public void login_addProd_UPI_PaymentOption_logout(String un, String pwd) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Assert.assertTrue("UPI option is not present", checkout.is_UPI_PaymentOptionSelected());
		System.out.println("UPI option is selected successsfully");

...
public class Amz_TC_10 extends Launch_Quit_Browser
{
	...
	public void login_addProd_netBanking_PaymentOption_logout(String un, String pwd) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Assert.assertTrue("Net Banking option is not present", checkout.is_NetBanking_PaymentOptionSelected());
		System.out.println("Net Banking option is selected successsfully");
